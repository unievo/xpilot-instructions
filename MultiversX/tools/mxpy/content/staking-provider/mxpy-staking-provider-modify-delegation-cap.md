# mxpy staking-provider modify-delegation-cap

Modify the delegation contract capacity. Must be called by the contract owner.

## Usage

```bash
mxpy staking-provider modify-delegation-cap [options]
```

## Parameters

- `--delegation-cap DELEGATION_CAP`  
  Integer. New delegation contract capacity.
...
```bash
mxpy staking-provider modify-delegation-cap --delegation-cap 1000000000000000000000 --delegation-contract erd1... --proxy https://devnet-gateway.multiversx.com --pem owner.pem --send
