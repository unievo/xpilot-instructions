...
Stake nodes in a delegation contract. Must be called by the contract owner.
...
```bash
mxpy staking-provider stake-nodes --bls-keys bls1,bls2 --delegation-contract erd1... --proxy https://devnet-gateway.multiversx.com --pem owner.pem --send
