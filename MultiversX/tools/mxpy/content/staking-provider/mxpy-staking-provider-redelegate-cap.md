# mxpy staking-provider redelegate-cap

Set or unset redelegate cap for a delegation contract. Must be called by the contract owner.
...
- `--set`  
  Flag. Set redelegate cap to True.
- `--unset`  
  Flag. Set redelegate cap to False.
...
```bash
mxpy staking-provider redelegate-cap --set --delegation-contract erd1... --proxy https://devnet-gateway.multiversx.com --pem owner.pem --send
