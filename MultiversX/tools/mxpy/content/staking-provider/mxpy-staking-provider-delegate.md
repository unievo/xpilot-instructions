...
```bash
mxpy staking-provider delegate [options]
```
...
```bash
mxpy staking-provider delegate --delegation-contract erd1... --proxy https://devnet-gateway.multiversx.com --pem delegator.pem --value 1000000000000000000 --send
