# mxpy staking-provider withdraw
...
```bash
mxpy staking-provider withdraw [options]
```
...
```bash
mxpy staking-provider withdraw --delegation-contract erd1... --proxy https://devnet-gateway.multiversx.com --pem delegator.pem --send
