# mxpy governance close-proposal
...
```bash
mxpy governance close-proposal --proposal-nonce PROPOSAL_NONCE [options]
```
...
```bash
mxpy governance close-proposal --proposal-nonce 42 --sender alice --send
