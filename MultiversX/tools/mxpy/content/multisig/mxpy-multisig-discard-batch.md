...
```bash
mxpy multisig discard-batch --action-ids ACTION_IDS [ACTION_IDS ...] --contract CONTRACT [options]
```

## Parameters

- `--action-ids ACTION_IDS [ACTION_IDS ...]`  
  The IDs of the actions to discard.
...
```bash
mxpy multisig discard-batch --action-ids 42 43 44 --contract msig1 --sender alice --send
