...
```bash
mxpy multisig unsign-batch --batch BATCH --contract CONTRACT [options]
```

## Parameters

- `--batch BATCH`  
  The id of the batch to unsign.
...
```bash
mxpy multisig unsign-batch --batch 42 --contract msig1 --sender alice --send
