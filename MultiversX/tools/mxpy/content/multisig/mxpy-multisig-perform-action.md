...
```bash
mxpy multisig perform-action --action ACTION --contract CONTRACT [options]
```
...
```bash
mxpy multisig perform-action --action 42 --contract msig1 --sender alice --send
