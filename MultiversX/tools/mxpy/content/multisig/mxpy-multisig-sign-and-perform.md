# mxpy multisig sign-and-perform
...
```bash
mxpy multisig sign-and-perform --action ACTION --contract CONTRACT [options]
```
...
```bash
mxpy multisig sign-and-perform --action 42 --contract msig1 --sender alice --send
