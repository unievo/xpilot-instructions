# mxpy multisig sign-batch-and-perform
...
```bash
mxpy multisig sign-batch-and-perform --batch BATCH --contract CONTRACT [options]
```

## Parameters

- `--batch BATCH`  
  The id of the batch to sign.
...
```bash
mxpy multisig sign-batch-and-perform --batch 42 --contract msig1 --sender alice --send
