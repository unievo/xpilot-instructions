...
```bash
mxpy multisig sign-action --action ACTION --contract CONTRACT [options]
```
...
```bash
mxpy multisig sign-action --action 42 --contract msig1 --sender alice --send
