...
```bash
mxpy multisig unsign-action --action ACTION --contract CONTRACT [options]
```
...
```bash
mxpy multisig unsign-action --action 42 --contract msig1 --sender alice --send
