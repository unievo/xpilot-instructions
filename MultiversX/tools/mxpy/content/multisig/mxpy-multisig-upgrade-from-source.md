# mxpy multisig upgrade-from-source
...
```bash
mxpy multisig upgrade-from-source --contract-to-upgrade CONTRACT_TO_UPGRADE --contract-to-copy CONTRACT_TO_COPY [--contract-abi CONTRACT_ABI] [--arguments ARGUMENTS ...] [options]
```

## Parameters

- `--contract-to-upgrade CONTRACT_TO_UPGRADE`  
...
```bash
mxpy multisig upgrade-from-source --contract-to-upgrade sc1 --contract-to-copy sc2 --contract msig1 --sender alice --send
