...
```bash
mxpy multisig remove-user --user USER --contract CONTRACT [options]
```

## Parameters

- `--user USER`  
  Bech32 address of the proposed user to be removed.
...
```bash
mxpy multisig remove-user --user bob --contract msig1 --sender alice --send
