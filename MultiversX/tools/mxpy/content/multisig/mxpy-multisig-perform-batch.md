...
```bash
mxpy multisig perform-batch --batch BATCH --contract CONTRACT [options]
```

## Parameters

- `--batch BATCH`  
  The id of the batch to perform.
...
```bash
mxpy multisig perform-batch --batch 42 --contract msig1 --sender alice --send
