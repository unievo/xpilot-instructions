# mxpy multisig unsign-for-outdated-members
...
```bash
mxpy multisig unsign-for-outdated-members --action ACTION --outdated-members OUTDATED_MEMBERS [OUTDATED_MEMBERS ...] --contract CONTRACT [options]
```
...
```bash
mxpy multisig unsign-for-outdated-members --action 42 --outdated-members 1 2 --contract msig1 --sender alice --send
