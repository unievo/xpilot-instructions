...
```bash
mxpy multisig add-proposer --proposer PROPOSER --contract CONTRACT [options]
```

## Parameters

- `--proposer PROPOSER`  
  Bech32 address of the proposed proposer.
...
```bash
mxpy multisig add-proposer --proposer bob --contract msig1 --sender alice --send
