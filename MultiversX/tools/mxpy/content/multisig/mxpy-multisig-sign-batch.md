...
```bash
mxpy multisig sign-batch --batch BATCH --contract CONTRACT [options]
```
...
```bash
mxpy multisig sign-batch --batch 42 --contract msig1 --sender alice --send
