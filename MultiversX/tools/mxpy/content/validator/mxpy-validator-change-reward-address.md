# mxpy validator change-reward-address
...
```bash
mxpy validator change-reward-address [options]
```
...
- `--reward-address REWARD_ADDRESS`  
  string, the new reward address

## Example

```bash
mxpy validator change-reward-address --proxy https://gateway.example.com --pem wallet.pem --reward-address erd1... --send
