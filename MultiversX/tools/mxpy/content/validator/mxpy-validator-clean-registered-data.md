# mxpy validator clean-registered-data
...
```bash
mxpy validator clean-registered-data [options]
```
...
```bash
mxpy validator clean-registered-data --proxy https://gateway.example.com --pem wallet.pem --send
