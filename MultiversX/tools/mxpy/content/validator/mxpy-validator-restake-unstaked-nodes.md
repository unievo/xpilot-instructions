# mxpy validator restake-unstaked-nodes
...
```bash
mxpy validator restake-unstaked-nodes [options]
```
...
```bash
mxpy validator restake-unstaked-nodes --proxy https://gateway.example.com --pem wallet.pem --nodes-public-keys addrA,addrB --send
